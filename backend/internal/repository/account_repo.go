...
var schedulerNeutralExtraKeys = map[string]struct{}{
	...
	service.AccountTestLatencyExtraKey:     {},
	service.AccountTestModelExtraKey:       {},
	service.AccountTestCompletedAtExtraKey: {},
}
...
// ClearTempUnschedulableIfReason clears a temporary block only if its reason
// still matches. Callers use this to avoid clearing a newer, unrelated block.
...
func (r *accountRepository) updateUpstreamBillingProbeSnapshotInTx(
	...
	probeEnabled, _ := account.Extra[service.UpstreamBillingProbeEnabledExtraKey].(bool)
	rateSyncEnabled, _ := account.Extra[service.UpstreamBillingRateSyncEnabledExtraKey].(bool)
	if rateMultiplier != nil && probeEnabled && rateSyncEnabled {
		...
		`, account.ID, *rateMultiplier); err != nil {
			return err
		}
	}
