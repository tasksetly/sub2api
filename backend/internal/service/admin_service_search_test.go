...
func (s *accountRepoStubForAdminList) ListWithFilters(_ context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode string, upstreamProviderID int64) ([]Account, *pagination.PaginationResult, error) {
	...
	s.listWithFiltersUpstream = upstreamProviderID
