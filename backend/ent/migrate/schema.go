...
var (
	...
	SupportTicketsColumns = []*schema.Column{
		...
		{Name: "admin_unread", Type: field.TypeBool, Default: true},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{SupportTicketsColumns[11], SupportTicketsColumns[7]},
			},
			{
				Name:    "supportticket_status_last_message_at",
				Unique:  false,
				Columns: []*schema.Column{SupportTicketsColumns[4], SupportTicketsColumns[7]},
			},
			{
			...
			{
				Name:    "supportticket_admin_unread",
				Unique:  false,
				Columns: []*schema.Column{SupportTicketsColumns[5]},
			},
			{
				Name:    "supportticket_user_unread",
				Unique:  false,
	...
	SupportTicketAttachmentsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "support_ticket_attachments_support_tickets_attachments",
				Columns:    []*schema.Column{SupportTicketAttachmentsColumns[6]},
			...
			},
			{
				...
				Columns:    []*schema.Column{SupportTicketAttachmentsColumns[8]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "supportticketattachment_ticket_id",
				Unique:  false,
				Columns: []*schema.Column{SupportTicketAttachmentsColumns[6]},
			},
			{
				Name:    "supportticketattachment_message_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{SupportTicketAttachmentsColumns[7], SupportTicketAttachmentsColumns[5]},
			},
			{
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{SupportTicketMessagesColumns[5], SupportTicketMessagesColumns[4]},
			},
			{
...
func init() {
	...
	SupportTicketAttachmentsTable.ForeignKeys[0].RefTable = SupportTicketsTable
	SupportTicketAttachmentsTable.ForeignKeys[1].RefTable = SupportTicketMessagesTable
