<template>
  <div class="mt-4 w-full min-w-0 pt-3 border-t border-gray-100 dark:border-dark-700/60">
    <div
    ...
    <div v-else class="flex min-w-0 items-end gap-[2px] h-5 w-full overflow-hidden">
      <div
