export default {
    accounts: {
      ...
      searchAccounts: '搜索账号...',
      supplier: '供应商',
      supplierPlaceholder: '例如：官方渠道、代理商 A',
      supplierHint: '用于将多个上游账号归集到同一成本主体',
      supplierUnset: '未设置',
      notes: '备注',
      ...
      bulkActions: {
        ...
        testing: '测试中...',
        startTest: '开始测试',
        selectTestModelTitle: '选择批量测试模型',
        selectedForTest: '已选择 {count} 个账号，将使用同一个模型测试。',
        loadingTestModels: '正在加载选中账号的共同模型...',
        loadTestModelsFailed: '加载测试模型失败，请稍后重试。',
        noCommonTestModels: '选中账号没有共同可用的测试模型。',
        testConfirm: '确定要测试选中的 {count} 个账号吗？',
        testSuccess: '已完成 {count} 个账号测试，成功账号已取消选择',
        testPartialSuccess: '账号测试完成：{success} 成功，{failed} 失败（失败账号已保留选择）',
      ...
      bulkEdit: {
        ...
        supplierNotice: '启用后统一设置供应商；留空并提交可清除现有供应商',
        submit: '批量更新',
        updating: '更新中...',
