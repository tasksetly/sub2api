export default {
  tickets: {
    title: '我的工单',
    description: '提交问题并跟踪处理进度',
    adminTitle: '工单管理',
    adminDescription: '集中处理用户问题并推进工单状态',
    new: '新建工单',
    create: '提交工单',
    createFirst: '提交第一个工单',
    listTitle: '工单列表',
    empty: '暂无符合条件的工单',
    selectPrompt: '选择一个工单查看会话',
    search: '搜索主题、用户或邮箱',
    allStatuses: '全部状态',
    allCategories: '全部分类',
    allPriorities: '全部优先级',
    ...
    send: '发送',
    addImages: '添加图片',
    attachmentHint: '支持 JPG、PNG、GIF、WebP，单张最大 {size} MB，最多 {count} 张',
    attachmentTypeInvalid: '仅支持 JPG、PNG、GIF 和 WebP 图片',
