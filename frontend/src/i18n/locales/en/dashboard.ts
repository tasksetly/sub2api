export default {
  ...
  keys: {
    ...
    test: {
      ...
      ready: 'Ready to test. Click Start Test to verify the key connection.',
      connecting: 'Connecting to API...',
      completed: 'Connection test completed',
      testing: 'Testing...',
      start: 'Start Test',
      retry: 'Test Again',
      copyOutput: 'Copy test output',
      outputCopied: 'Test output copied',
      testModel: 'Model request test',
      noGroup: 'This key has no assigned group and cannot be tested.',
      keyUnavailable: 'Only active API keys can be tested.',
      loadModelsFailed: 'Failed to load available models',
      noModels: 'No text models are available for this group.',
      httpError: 'API request failed (HTTP {status})',
      noResponseBody: 'The API returned no response body.',
      responseFailed: 'The Responses API returned a failed status.',
      invalidStream: 'The API returned an invalid streaming response.',
      streamEndedUnexpectedly: 'The API stream ended before completion.',
      unknownError: 'Unknown error',
      starting: 'Starting test for key: {name}',
      groupLabel: 'Group: {group}',
      connected: 'Connected to the API gateway',
      usingModel: 'Using model: {model}',
      sending: 'Sending test message...',
      response: 'Response:',
      gatewayVerified: 'Verified through {endpoint}'
    },
    useKeyModal: {
      title: 'Use API Key',
      description:
