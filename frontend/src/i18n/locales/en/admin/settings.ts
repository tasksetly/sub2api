export default {
    settings: {
      ...
      site: {
        ...
        remove: 'Remove',
        logoHint: 'PNG, JPG, or SVG. Max 1MB. Rectangular images are supported and shown as the full brand logo in the expanded console sidebar.',
        faviconHint: 'Upload a separate SVG, PNG, or JPG icon for browser tabs. Max 1MB. Empty falls back to the site logo.',
