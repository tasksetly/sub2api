    ...
    settings: {
      ...
      features: {
        ticketStorage: {
          ...
          description: 'Configure S3-compatible object storage for ticket images, including Cloudflare R2, AWS S3, and MinIO.',
          statusEnabled: 'Enabled',
          statusDisabled: 'Disabled',
          enabled: 'Enable image attachments',
          enabledHint: 'Allow users and administrators to upload images in ticket messages.',
          endpoint: 'S3 Endpoint',
          endpointHint: 'Leave empty for AWS S3. R2, MinIO, and other compatible services require a full HTTPS URL.',
          region: 'Region',
          bucket: 'Bucket',
          accessKeyId: 'Access Key ID',
          secretAccessKey: 'Secret Access Key',
          secretConfigured: 'Configured; leave empty to keep unchanged',
          secretHint: 'The secret is stored encrypted and is never returned to this page.',
          prefix: 'Object Prefix',
          forcePathStyle: 'Use Path Style',
          forcePathStyleHint: 'Usually enabled for MinIO and disabled for Cloudflare R2.',
          maxFileSize: 'Per-image limit (MB)',
          maxAttachments: 'Images per message',
          urlExpiry: 'Signed URL lifetime (minutes)',
          testConnection: 'Test connection',
          testing: 'Testing...',
          save: 'Save attachment settings',
          saving: 'Saving...',
          saved: 'Ticket attachment storage settings saved and applied',
          testSuccess: 'S3 connection successful',
          testFailed: 'S3 connection failed',
          loadFailed: 'Failed to load ticket attachment storage settings',
          saveFailed: 'Failed to save ticket attachment storage settings',
        },
        channelMonitor: {
