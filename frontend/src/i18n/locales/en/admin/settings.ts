export default {
    settings: {
      ...
      ticketStorage: {
        ...
        description: 'S3-compatible object storage for Cloudflare R2, AWS S3, MinIO, and OSS.',
        endpoint: 'Endpoint',
        region: 'Region',
        bucket: 'Bucket',
        ...
        maxSize: 'Max Image Size (MB)',
        maxFiles: 'Images per Message',
        test: 'Test Connection',
        testSuccess: 'Object storage connection succeeded',
        testFailed: 'Object storage connection failed',
        loadFailed: 'Failed to load ticket storage settings',
        saveFailed: 'Failed to save ticket storage settings',
      },
      features: {
        channelMonitor: {
      ...
      scheduling: {
        ...
        selectionMode: 'Account selection mode',
        selectionModeHint: 'Controls selection among available accounts in the same group; sticky sessions still take precedence.',
      ...
      site: {
        ...
        brandAssetsTitle: 'Brand Images',
        brandAssetsDescription: 'Configure separate images for navigation, page content, and browser tabs.',
        siteLogo: 'Navigation Logo',
        siteContentLogo: 'Page Content Logo',
        siteFavicon: 'Favicon',
        uploadImage: 'Upload Image',
        remove: 'Remove',
        logoHint: 'PNG, JPG, or SVG. Max 1MB. Used in the console sidebar, home page, and other navigation areas. Empty uses the default logo.',
        contentLogoHint: 'PNG, JPG, or SVG. Max 1MB. Used on login/register pages and the compact home page. Empty falls back to the navigation logo.',
        faviconHint: 'Upload a separate SVG, PNG, or JPG icon for browser tabs. Max 1MB. Empty falls back to the navigation logo.',
      ...
      payment: {
        ...
        validationEasyPayCustomMethodFeeRateInvalid: 'Custom EasyPay method fee rates must be between 0 and 100 with at most 2 decimal places',
        field_apiBase: 'API Base URL',
        field_easyPayApiBaseHint: 'Use the provider root URL for standard EasyPay. For Epusdt, use https://<domain>/payments/epay/v1/order/create-transaction (or the full submit.php URL); redirect checkout is selected automatically.',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on Sub2API orders; the upstream type is sent as EasyPay type. Empty fee rates use the global setting, and matching methods across enabled instances should use the same rate.',
        ...
        customMethodFeeRate: 'Fee rate',
        customMethodFeeRatePlaceholder: 'Global',
