export default {
    accounts: {
      ...
      supplier: 'Supplier',
      supplierPlaceholder: 'e.g. Official channel or Reseller A',
      supplierHint: 'Groups multiple upstream accounts under one cost owner',
      supplierUnset: 'Not set',
      notes: 'Notes',
      ...
      allUpstreams: 'All sources',
      anyUpstream: 'From upstream',
      ...
      bulkActions: {
        ...
        selectTestModelTitle: 'Select Batch Test Model',
        selectedForTest: '{count} account(s) selected. The same model will be used for each test.',
        loadingTestModels: 'Loading models shared by the selected accounts...',
        loadTestModelsFailed: 'Failed to load test models. Try again later.',
        noCommonTestModels: 'The selected accounts have no common test model.',
        testConfirm: 'Test the selected {count} account(s)?',
        testSuccess: 'Tested {count} account(s); successful accounts were deselected',
        testPartialSuccess: 'Account testing completed: {success} succeeded, {failed} failed (failed accounts remain selected)',
      ...
      bulkEdit: {
        ...
        supplierNotice: 'When enabled, applies one supplier to all targets; submit an empty value to clear it',
